...
START_PIC = os.environ.get("START_PIC", "https://envs.sh/SgP.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/Sgi.jpg")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• By @XShadow3773</b>")
